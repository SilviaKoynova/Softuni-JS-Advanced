class Company {
    ...
    bestDepartment() {
        ...
        if(!department == '') {
            ...
            Object.values(this._departments[department]).sort((a, b) => b.salary - a.salary || a.name.localeCompare(b.name)).forEach(e => {
                let currentEmployee = `${e.name} ${e.salary} ${e.position}\n`;
